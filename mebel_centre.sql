...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3919779372ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="227">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Недавние таблицы" class="drop_button btn">Недавнее</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mebel_centre&table=category">`mebel_centre`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mebel_centre&table=product">`mebel_centre`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mebel_centre&table=user">`mebel_centre`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=it_control_bot&table=account">`it_control_bot`.`account`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=it_control_bot&table=circle">`it_control_bot`.`circle`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=it_control_bot&table=circle_students">`it_control_bot`.`circle_students`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=it_control_bot&table=equipment">`it_control_bot`.`equipment`</a></li></ul></div><div class="drop_list"><button title="Избранные таблицы" class="drop_button btn">Избранное</button><ul id="pma_favorite_list"><li class="warp_link">Нет избранных таблиц.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="663521356e523528367661793a4b542a">
...
</span><small>Установите 0, чтобы свернуть панель навигации.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="227"><a class="restore-default hide" href="#NavigationWidth" title="Восстановить изначальное значение"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
